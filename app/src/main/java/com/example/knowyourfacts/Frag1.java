...
public class Frag1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Frag1 = view.findViewById(R.id.interestingFacts);
        iv = view.findViewById(R.id.iv);
        String imageUrl = "https://www.wtffunfact.com/wtf-fun-fact-dead-snail-in-a-beer/";
        Context context = container.getContext();
        Picasso.with(context).load(imageUrl).into(iv);
        btnChangeColor = view.findViewById(R.id.buttonChangeColour);
